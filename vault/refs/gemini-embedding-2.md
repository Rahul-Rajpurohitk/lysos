...
- [Specify task type to improve performance](https://ai.google.dev/gemini-api/docs/embeddings#task-types)
  - [Task types with Embeddings 2](https://ai.google.dev/gemini-api/docs/embeddings#task-types-embeddings-2)
  - [Task types with Embeddings 1](https://ai.google.dev/gemini-api/docs/embeddings#task-types-embeddings-1)
...
- [Multimodal embeddings](https://ai.google.dev/gemini-api/docs/embeddings#multimodal)
  - [Supported modalities and limits](https://ai.google.dev/gemini-api/docs/embeddings#supported-modalities)
  - [Embedding images](https://ai.google.dev/gemini-api/docs/embeddings#embed-images)
  - [Embedding aggregation](https://ai.google.dev/gemini-api/docs/embeddings#embedding-aggregation)
  - [Embedding audio](https://ai.google.dev/gemini-api/docs/embeddings#embed-audio)
  - [Embedding video](https://ai.google.dev/gemini-api/docs/embeddings#embed-video)
  - [Embedding documents](https://ai.google.dev/gemini-api/docs/embeddings#embed-documents)
...
- [Migration from gemini-embedding-001](https://ai.google.dev/gemini-api/docs/embeddings#migration)
...
multiple inputs. You can find more information in [Embedding aggregation](https://ai.google.dev/gemini-api/docs/embeddings#embedding-aggregation),
or you can use the [Batch API](https://ai.google.dev/gemini-api/docs/batch-api#batch-embedding) if
...
| --- | --- | --- |
| Search query | `task: search result | query: {content}` | `title: {title} | text: {content}`<br>If there is no title, use `title: none`. |
...
| Semantic similarity | `task: sentence similarity | query: {content}`<br>Do not use this for search or retrieval. It is intended for semantic textual similarity. |
...
| **Video** | Maximum duration of 120 seconds. Supported formats: MP4, MOV. Supported codecs: H264, H265, AV1, VP9.<br> The system processes a maximum of 32 frames per video: short videos (≤32s) are sampled at 1 fps, while longer videos are uniformly sampled to 32 frames. Audio tracks are not processed in video files. |
...
[Gemini Embedding 2](https://ai.google.dev/gemini-api/docs/embeddings#gemini-embedding-2)[Gemini Embedding](https://ai.google.dev/gemini-api/docs/embeddings#gemini-embedding)More

| Property | Description |
| --- | --- |
| id\_cardModel code | **Gemini API**<br>`gemini-embedding-2` |
| saveSupported data types | **Input**<br>Text, image, video, audio, PDF<br>**Output**<br>Text embeddings |
| token\_autoToken limits[\[\*\]](https://ai.google.dev/gemini-api/docs/tokens) | **Input token limit**<br>8,192<br>**Output dimension size**<br>Flexible, supports: 128 - 3072, Recommended: 768, 1536, 3072 |
| 123Versions | Read the [model version patterns](https://ai.google.dev/gemini-api/docs/models/gemini#model-versions) for more details.<br>- Stable: `gemini-embedding-2` |
...
- [Manage cookies](https://ai.google.dev/gemini-api/docs/embeddings#)
